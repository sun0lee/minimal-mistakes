...
#### 위험경감
- 29 [**위험경감기법 운영기준 (IV.1-5.라.(1))**]({{ "./collections/kics/04-scr/01-intro/05-위험경감기법/#1-문서화" | relative_url }})
- 30 [**포트폴리오 헤지방식 (IV.1-5.마.(2))**]({{ "./collections/kics/04-scr/01-intro/05-위험경감기법/#2-포트폴리오-헤지변액보험" | relative_url }})을 사용하는 경우의 주기적 헤지효과 분석
- 31 갱신 및 재계약에 대한 실현가능성 및 과거 재보험 전략과의 일관성 등을 포함한 [**재보험계약 갱신계획 (IV.1-5.바.(3)1.)**]({{ "./collections/kics/04-scr/01-intro/05-위험경감기법/#1-재보험계약-갱신계획" | relative_url }})
- 32 시장위험액 위험경감기법의 갱신 필요성, 갱신전략, 갱신 실행과정의 예상비용 및 제반위험 등 [**시장위험 관련 파생상품 갱신 관련 내용 (IV.1-5.바.(4)1ᄀ.**)]({{ "./collections/kics/04-scr/01-intro/05-위험경감기법/#1-갱신조건" | relative_url }})
- 33 헤지전략, 헤지 실행과정의 비용 및 헤지효과 분석 등 [**동적 헤지 관련 (IV.1-5.바.(5)1.)**]({{ "./collections/kics/04-scr/01-intro/05-위험경감기법/#1-헤지-관련-내용-문서화" | relative_url }}) 내용
